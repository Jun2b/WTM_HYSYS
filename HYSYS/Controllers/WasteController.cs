...
namespace HYSYS.Controllers
{
    ...
    [ActionDescription("损耗")]
    public partial class WasteController : BaseController
    {
        #region 搜索
        [ActionDescription("搜索")]
        public ActionResult Index()
        {
            var vm = CreateVM<WasteListVM>();
        ...
        {
            var vm = CreateVM<WasteBatchVM>(Ids: IDs);
            return PartialView(vm);
        }

        [HttpPost]
        [ActionDescription("批量修改")]
        public ActionResult DoBatchEdit(WasteBatchVM vm, IFormCollection nouse)
        {
        ...
        [HttpPost]
        [ActionDescription("批量删除")]
        public ActionResult DoBatchDelete(WasteBatchVM vm, IFormCollection nouse)
        {
        ...
        {
            var vm = CreateVM<WasteImportVM>();
            return PartialView(vm);
        }

        [HttpPost]
        [ActionDescription("导入")]
        public ActionResult Import(WasteImportVM vm, IFormCollection nouse)
        {
